...
./build/Rust_Compiler ./result/input/6.1.1.txt ./result/asm/6.1.1.asm > ./result/output/6.1.1.txt
./build/Rust_Compiler ./result/input/6.1.2_error.txt ./result/asm/6.1.2_error.asm > ./result/output/6.1.2_error.txt

./build/Rust_Compiler ./result/input/6.2.1.txt ./result/asm/6.2.1.asm > ./result/output/6.2.1.txt
./build/Rust_Compiler ./result/input/6.2.2.txt ./result/asm/6.2.2.asm > ./result/output/6.2.2.txt
./build/Rust_Compiler ./result/input/6.2.3_error.txt ./result/asm/6.2.3_error.asm > ./result/output/6.2.3_error.txt
./build/Rust_Compiler ./result/input/6.2.4_error.txt ./result/asm/6.2.4_error.asm > ./result/output/6.2.4_error.txt
./build/Rust_Compiler ./result/input/6.2.5_error.txt ./result/asm/6.2.5_error.asm > ./result/output/6.2.5_error.txt
./build/Rust_Compiler ./result/input/6.2.6.txt ./result/asm/6.2.6.asm > ./result/output/6.2.6.txt
```
